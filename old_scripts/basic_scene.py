...
plastic = materials.create_plastic("GroundPlastic", (1, 1, 1))

# Create an object at the origin with a selected material
sphere_position = (0,2,0)
sphere = builder.add_sphere("/World/Sphere", radius=1.0, material=blue_paint, position=sphere_position)
floor = builder.add_plane("/World/Floor", size = 15, material=plastic)

# Add a static camera looking at the object
camera_path = "/World/Camera"
camera_position = (-10, 15, -10)
camera.add_camera(camera_path, camera_position, target=sphere_position)
